...
export const TOOLBAR_FOOTER_CLS = cn(
  SMALL_BUTTON_H_CLS,
  CENTERED_ROW_CLS,
  "border-t border-border px-2 text-xs text-foreground/50 overflow-hidden justify-between grid grid-cols-3 shrink-0 fixed left-0 right-0 bottom-0 w-full bg-body z-10",
)
